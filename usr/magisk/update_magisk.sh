...
then
	nver="canary"
	magisk_link="https://github.com/topjohnwu/magisk-files/raw/canary/app-debug.apk"
elif [ "x$1" = "xalpha" ]
then
	nver="alpha"
	magisk_link="https://github.com/vvb2060/magisk_files/raw/alpha/app-release.apk"
else
	if [ "x$1" = "x" ]; then
